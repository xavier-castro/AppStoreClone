...
class AppFullscreenController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    fileprivate func setupFloatingControls() {
        ...
        floatingContainerView.anchor(top: nil, leading: view.leadingAnchor, bottom: view.bottomAnchor, trailing: view.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 16, bottom: bottomPadding, right: 16), size: CGSize(width: 0, height: 90))
        ...
        stackView.fillSuperview(padding: UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 18))
